...
app.get('/login', sessionHandler.displayLoginPage);
 ...
 app.get('/itemlist/:id', sessionHandler.handleGetSingleInventoryItem);

 app.delete('/itemlist/:id', sessionHandler.handleDeleteSingleInventoryItem);

app.put('/itemlist/:id', sessionHandler.handleUpdateSingleInventoryItem);
 ...
 // Welcome page
  ...
  app.get("/main", sessionHandler.displayWelcomePage);
  app.post('/main', contentHandler.handleDonateRequest);
